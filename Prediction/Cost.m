function [C] = Cost(ExaminedTrajectories, x, T)

    c1=0; c2=0; c3=0; c4=0; c5=0; c6=0; c7=0; c8=0;     
    
    for i=1:T
        c1 = c1 + (ExaminedTrajectories.Susceptible(i)-x(1,i))*((ExaminedTrajectories.Susceptible(i)-x(1,i)).');
        c2 = c2 + (ExaminedTrajectories.Infected(i)-x(2,i))*((ExaminedTrajectories.Infected(i)-x(2,i)).');
        c3 = c3 + (ExaminedTrajectories.VaccinatedInfected(i)-x(3,i))*((ExaminedTrajectories.VaccinatedInfected(i)-x(3,i)).');

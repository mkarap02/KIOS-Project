...
VaccinationsPerDay = readtable('ActiveVaccinatedEveryday.csv');
...
VaccinationsPerDay.Vaccinations=VaccinationsPerDay.Vaccinations/population;

for i=600:600   %loop for all the days

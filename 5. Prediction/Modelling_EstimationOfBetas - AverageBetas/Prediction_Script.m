...
Trajectories = readtable('Trajectories_14092020_24032022.csv');
Active=Trajectories;
days=height(Trajectories);
ParametersResults = readtable('beta_predicted_win14_pred7_mem180_20reps.csv');  %Values of the 4 parameters from System Identification
